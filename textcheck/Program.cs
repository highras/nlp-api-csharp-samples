...
namespace com.ilivedata.textcheck
{
    class Program
    {
        ...
        private string postUrl = "https://tsafe.ilivedata.com/api/v1/text/check";
        private string endpointHost = "tsafe.ilivedata.com";
        private string endpointUri = "/api/v1/text/check";
