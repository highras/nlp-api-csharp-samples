...
namespace com.ilivedata.videocheckresult
{
    class Program
    {
        ...
        private string postUrl = "https://vsafe.ilivedata.com/api/v1/video/check/result";
        private string endpointHost = "vsafe.ilivedata.com";
        private string endpointUri = "/api/v1/video/check/result";
