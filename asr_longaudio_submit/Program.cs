...
namespace asr_longaudio_submit
{
    class Program
    {
        ...
        private string postUrl = "https://asr.ilivedata.com/api/v1/speech/recognize/submit";
        private string endpointHost = "asr.ilivedata.com";
        private string endpointUri = "/api/v1/speech/recognize/submit";
        ...
        public string Recognize(string audioUrl, string languageCode, string userId, bool speakerDiarization)
        {
            string now = DateTime.UtcNow.ToString(ISO8601DateFormatNoMS);

            // Optional parameter config
            IDictionary<string, object> config = new Dictionary<string, object>();
            config.Add("codec", "PCM");
            config.Add("sampleRateHertz", 16000);

            // Optional parameter diarizationConfig
            IDictionary<string, object> diarizationConfig = new Dictionary<string, object>();
            config.Add("enableSpeakerDiarization", speakerDiarization);

            IDictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("languageCode", languageCode);
            parameters.Add("diarizationConfig", diarizationConfig);
            parameters.Add("config", config);
            parameters.Add("uri", audioUrl);
