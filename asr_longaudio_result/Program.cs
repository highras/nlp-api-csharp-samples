...
namespace asr_longaudio_result
{
    class Program
    {
        ...
        private string postUrl = "https://asr.ilivedata.com/api/v1/speech/recognize/result";
        private string endpointHost = "asr.ilivedata.com";
        private string endpointUri = "/api/v1/speech/recognize/result";
        ...
        {
            string taskID = "us_02490705-85c3-4020-aac3-e5718b6493e9_1615173965831";
            Program speech = new Program();
            speech.GetResult(taskID);
