...
namespace com.ilivedata.audiocheckresult
{
    class Program
    {
        ...
        private string postUrl = "https://asafe.ilivedata.com/api/v1/audio/check/result";
        private string endpointHost = "asafe.ilivedata.com";
        private string endpointUri = "/api/v1/audio/check/result";
