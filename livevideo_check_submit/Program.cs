...
namespace com.ilivedata.livevideochecksubmit
{
    class Program
    {
        ...
        private string postUrl = "https://vsafe.ilivedata.com/api/v1/livevideo/check/submit";
        private string endpointHost = "vsafe.ilivedata.com";
        private string endpointUri = "/api/v1/livevideo/check/submit";
        ...
        public string check(string videoUrl, int type, string userId)
        {
            string now = DateTime.UtcNow.ToString(ISO8601DateFormatNoMS);

            IDictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("type", type);
            parameters.Add("video", videoUrl);
        ...
        {
            string videoUrl = "LIVE_VIDEO_URL";
            Program videoCheck = new Program();
            videoCheck.check(videoUrl, 1, "12345678");
        }
    }
}
