...
namespace com.ilivedata.imagecheck
{
    class Program
    {
        ...
        private string postUrl = "https://isafe.ilivedata.com/api/v1/image/check";
        private string endpointHost = "isafe.ilivedata.com";
        private string endpointUri = "/api/v1/image/check";
        ...
        public string check(string image, int type, string userId)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Program imageCheck = new Program();
            imageCheck.check(image, 2, "12345678");
        }
    }
}
