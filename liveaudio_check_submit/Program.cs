...
namespace com.ilivedata.liveaudio_check_submit
{
    class Program
    {
        ...
        private string postUrl = "https://asafe.ilivedata.com/api/v1/liveaudio/check/submit";
        private string endpointHost = "asafe.ilivedata.com";
        private string endpointUri = "/api/v1/liveaudio/check/submit";
