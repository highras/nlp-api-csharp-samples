...
namespace com.ilivedata.rcs
{
    class Program
    {
		...
		private string postUrl = "https://profanity.ilivedata.com/api/v2/profanity";
		private string endpointHost = "profanity.ilivedata.com";
		private string endpointUri = "/api/v2/profanity";
		...
		public string Profanity(string sentence, int classify, string userId, string userName)
		{   
			string now = DateTime.UtcNow.ToString(ISO8601DateFormatNoMS);

			IDictionary<string, string> parameters = new Dictionary<string, string>();
			parameters.Add("classify", classify.ToString());
			parameters.Add("userId", userId);
			parameters.Add("userName", userName);
			parameters.Add("q", sentence);
        ...
        {
            Program riskyContent = new Program();
            riskyContent.Profanity ("加抠13812123434", 1, "12345678", "张三");
		    riskyContent.Profanity ("武汉肺炎", 0, "12345678", "张三");
