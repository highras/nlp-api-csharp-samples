...
namespace com.ilivedata.livevideocheckresult
{
    class Program
    {
        ...
        private string postUrl = "https://vsafe.ilivedata.com/api/v1/livevideo/check/result";
        private string endpointHost = "vsafe.ilivedata.com";
        private string endpointUri = "/api/v1/livevideo/check/result";
        ...
        static void Main(string[] args)
        {
            ...
            Program videocheckresult = new Program();
